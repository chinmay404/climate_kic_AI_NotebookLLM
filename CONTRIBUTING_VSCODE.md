...
This guide explains how to set up and use VSCode's debugging capabilities with Climate KIC.
...
3. From the dropdown at the top, select "Run All Services" and press the green play button
4. Now, you can navigate to Climate KIC in your browser (default is http://localhost:3000) and start using the app
