  ...
  return (
    <div className="mb-8">
      ...
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to Climate KIC. Once setup, you will be able to
        ask questions to Climate KIC directly from Slack. Additionally, you can:
      </p>

      <div className="mb-2">
        <ul className="list-disc mt-2 ml-4 text-sm text-muted-foreground">
          <li>
            Setup Climate KIC Bot to automatically answer questions in certain channels.
          </li>
          <li>
            Choose which document sets Climate KIC Bot should answer from, depending on
            the channel the question is being asked.
          </li>
          <li>
            Directly message Climate KIC Bot to search just as you would in the web UI.
          </li>
        </ul>
      </div>
