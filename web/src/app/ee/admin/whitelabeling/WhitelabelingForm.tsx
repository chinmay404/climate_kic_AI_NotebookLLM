        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving the application for your team. This will replace 'Climate KIC' everywhere in the UI.`}
              placeholder="Custom name which will replace 'Climate KIC'"
            ...
            <div>
              ...
              {values.use_custom_logo ? (
                ...
                <SubLabel>
                  Specify your own logo to replace the standard Climate KIC logo.
                </SubLabel>
              )}
                  ...
                  subtext={
                    values.enable_consent_screen
                      ...
                      : `The title for the popup that will be displayed for each user on their initial visit to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${
                          values.application_name || "Climate KIC"
                        }!".`
                  }
                  placeholder={
                    values.enable_consent_screen
